<template>
  <div class="retira-cuenta">
    ...
    <v-row>
      <v-col sm="6">
        <v-text-field
          ...
          type="number"
          label="Clave de cuenta de la que se retirará"
        ></v-text-field>
      </v-col>
      <v-col sm="6">
        <v-text-field
    ...
    <v-btn @click="retirar"> Retirar </v-btn>
    <div>
      <br />
  ...
  methods: {
    retirar() {
      if (typeof this.claveCuenta != "number") {
        ...
        let modificacion = {};
        modificacion.retiro = this.retiro;
        axios
          .patch(
            "https://localhost:4001/cuentas/" + this.claveCuenta + "/retiro",
            modificacion,
            {
              headers: {
